...
public class JwtTokenProvider {
    ...
    @Autowired
    public void setUserDetailsService(UserDetailsServiceImplements userDetailsServiceImplements) {
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = userDetailsServiceImplements.loadUserByUsername(getUsername(token));
